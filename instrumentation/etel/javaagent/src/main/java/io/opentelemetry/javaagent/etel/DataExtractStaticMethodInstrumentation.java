...
public class DataExtractStaticMethodInstrumentation implements TypeInstrumentation {
  ...
  public DataExtractStaticMethodInstrumentation(JavaMethodExtractTimingEnum timing, String className, String method,
      String... paramTypes) {
    this.timing = timing;
  ...
  public void transform(TypeTransformer transformer) {
    ElementMatcher.Junction junction = isMethod().and(named(method)).and(isStatic());
    junction = EasyTelemetryDataExtractModule.getJunction(junction, paramTypes);

    String enterAdvice = DataExtractStaticMethodInstrumentation.class.getName() + "$EnterAdvice";
    String exitAdvice = DataExtractStaticMethodInstrumentation.class.getName() + "$ExitAdvice";
  ...
  private static class ExitAdvice {
    ...
    public static void onMethodExit(
        final @Advice.Origin Method method,
        final @Advice.AllArguments Object[] params,
        final @Advice.Return @Nullable Object result) {
      JavaMethodDataExtractor.onMethodExit(method, params, result);
    }
