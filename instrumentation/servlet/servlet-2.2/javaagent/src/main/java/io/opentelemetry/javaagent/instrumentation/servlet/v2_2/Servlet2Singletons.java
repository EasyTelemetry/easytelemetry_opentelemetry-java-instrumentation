...
import io.easytelemetry.instrumentation.api.config.apply.extract.http.HttpRequestDataExtractor;
        ...
        instrumenter =
            AgentServletInstrumenterBuilder.<HttpServletRequest, HttpServletResponse>create()
                .build(
                    ...
                    spanNameExtractor,
                    httpAttributesGetter).setRequestDataExtractor(new HttpRequestDataExtractor<>(Servlet2RequestDataExtractor.INSTANCE));
