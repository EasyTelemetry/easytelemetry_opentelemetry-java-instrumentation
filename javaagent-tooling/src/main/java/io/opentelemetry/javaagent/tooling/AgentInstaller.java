...
import io.easytelemetry.javaagent.tooling.boot.EasyTelemetryBootstrap;
...
public class AgentInstaller {
  ...
  private static void installBytebuddyAgent(
    ...
    //启动easytelemetry
    EasyTelemetryBootstrap.start(ReflectionUtils.invoke(autoConfiguredSdk,"getResource"));
  ...
  public static AgentBuilder newAgentBuilder(ByteBuddy byteBuddy) {
